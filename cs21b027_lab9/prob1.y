...
%token POSNUMBER FLOAT PLUS MINUS SEP MUL DIV POW OPENB CLOSEB DOUBLEPLUS  DOUBLEMINUS VARIABLE EQUALS IF SWITCH ELSE OPENCB CLOSECB NOT DOUBLEEQUAL NOTEQUAL LESSTHANOREQUALTO GREATERTHANOREQUALTO LESSTHAN GREATERTHAN BOOLTRUE BOOLFALSE AND OR WHILE
//%type <dval> POSNUMBER
